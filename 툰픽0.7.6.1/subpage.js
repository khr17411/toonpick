...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const loggedTitles = JSON.parse(localStorage.getItem('loggedTitles') || '[]');
  
  if (!loggedTitles.includes(title) && title) {
    loggedTitles.push(title);
    localStorage.setItem('loggedTitles', JSON.stringify(loggedTitles));
